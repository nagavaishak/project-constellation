...
export const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Using FormSubmit.co service with proper content type
      ...
      toast({
        ...
        description: "There was a problem sending your message. Please try again later or contact directly via email.",
        variant: "destructive",
      });
    } finally {
